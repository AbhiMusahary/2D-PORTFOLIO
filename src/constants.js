...
export const dialogueData = {
  pc: `This is my PC. I work mostly in JavaScript/TypeScript these days.
    ...
    Here is my <a href="https://github.com/AbhiMusahary" target="_blank">Github</a>!`,
  ...
  I also Write Blogs. Go to <a href="https://aviitechnology.blogspot.com/" target="_blank">my channel</a>! (If you like the content)
  You'll learn about new techs in cybersecurity!`,
  ...
  resume: `This is my desk and on it is my resume. <a href="https://drive.google.com/file/d/1xwuMGjjRDmd3m4JKJYAMtfjsWv-5pQxW/view?usp=drive_link" target="_blank">Check it out?</a>
  Contact me at abhinishmusahary@gmail.com if you have any interesting job opportunities!`,
  ...
  library: `There are a lot of programming books on my shelves. There is even one in French (I also speak Bodo btw).
  I probably only read one of them. Who else compulsively buys technical books without ever finishing them?`,
  exit: `If you want to exit Abhinish portfolio, just close the tab.`,
};
